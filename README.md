...
существующего. Как показала практика, это весьма удобно при поиске ошибок, возникающих в процессе пакетной обработки данных, поскольку все проблемы оказываются привязаны к 
самим проблемным данным. Что именно будет записано в логе - зависит от конкретной утилиты и конкретных проблем, возникших при обработке содержимого архива.
