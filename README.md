...
Для взаимодействия с HTTP-сервером, из соображения совместимости с Java 9, используется проект [Apache HTTP-клиент](https://hc.apache.org/httpcomponents-client-5.2.x/). Для взаимодействия
