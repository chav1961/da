...
public class JsonWriter implements OutputConverterInterface {
	private static final URI	SERVE_URI = URI.create(CONV_SCHEMA+":"+DAContentFormat.RDF_JSON.getSchema()+":/");
